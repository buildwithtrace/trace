...
QUOTED_VALUE_FIELDS = {'name', 'number', 'property', 'symbol', 'uuid', 'label', 'global_label', 'hierarchical_label', 'path', 'generator', 'generator_version', 'paper', 'lib_id', 'lib_name', 'project', 'reference', 'page'}
