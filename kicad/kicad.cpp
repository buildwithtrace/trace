...
struct APP_KICAD : public wxApp
{
    ...
    bool OnInit()           override
    {
        ...
        // Check if we were launched with a trace:// URL (auth callback from browser)
        ...
        if( wxGetEnv( wxT( "TRACE_AUTH_CALLBACK_URL" ), &authCallbackUrl ) )
        {
            ...
            // Callback instance exits immediately — the running instance
            // detects the stored token via its poll timer.
            return false;
        }
#endif
