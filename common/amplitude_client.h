...
public:
    ...
    /**
     * Send an Amplitude $identify event that merges the current device_id
     * with the current user_id.  This retroactively links anonymous events
     * recorded under this device_id to the now-known user.
     */
    void IdentifyUser();
