...
private:
    ...
    std::vector<std::string> m_rules;      ///< rules are saved in std::string form.
};
...
private:
    ...
    boost::ptr_vector<PADSTACK> m_padstacks;      ///< all except vias, which are in 'vias'
...
private:
    ...
    std::vector<std::string>    m_layerIds;        ///< indexed by PCB layer number
