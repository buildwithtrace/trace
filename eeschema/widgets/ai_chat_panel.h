...
protected:
    ...
    void     RemapUndoRedoAfterReload() override;
    std::unique_ptr<AI_COMMIT> CreateAICommit() override;
     ...
     */
    void RestoreVersion( const wxString& versionId,
                         std::function<void( bool )> aOnComplete = nullptr ) override;
    ...
    void saveVersionToDatabase( const wxString& aDescription, int aTabIndex ) override;
