...
# Fix autotools install path issue on Windows - files get installed to usr/local/ instead of the prefix
# Move pkgconfig files from usr/local/lib/pkgconfig to lib/pkgconfig
if(EXISTS "${CURRENT_PACKAGES_DIR}/usr/local/lib/pkgconfig")
    file(MAKE_DIRECTORY "${CURRENT_PACKAGES_DIR}/lib/pkgconfig")
    file(GLOB PC_FILES "${CURRENT_PACKAGES_DIR}/usr/local/lib/pkgconfig/*.pc")
    foreach(PC_FILE ${PC_FILES})
        get_filename_component(PC_NAME "${PC_FILE}" NAME)
        file(RENAME "${PC_FILE}" "${CURRENT_PACKAGES_DIR}/lib/pkgconfig/${PC_NAME}")
    endforeach()
...
# icu-config may not exist on Windows builds
