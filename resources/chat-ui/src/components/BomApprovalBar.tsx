...
export default function BomApprovalBar({
  onApprove,
  onModify,
  onCancel
}: BomApprovalBarProps) {
      ...
      {showFeedback ? (
        <div className="plan-feedback-dialog">
          <div className="plan-feedback-header">
            What changes would you like to the BOM?
          </div>
          <textarea
            ...
            placeholder="Describe the modifications (e.g. use cheaper resistors, add Mouser links)..."
            autoFocus
          />
