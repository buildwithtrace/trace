...
interface TabBarProps {
  ...
  onNewTab: () => void
  onHistoryClick: (allProjects?: boolean) => void
...
export default function TabBar({
  ...
  // Default to showing just the current project's conversations to avoid leaking chats
  // from unrelated projects into the dropdown.
      ...
      <div className="tab-bar-actions">
        ...
        <div className="history-dropdown">
          <button
            ...
            onClick={() => onHistoryClick(showAllProjects)}
          ...
          {historyMenuOpen && menuPosition && (
            ...
            >
              ...
              <label className="history-all-projects-toggle" title="Include conversations from every project">
                <input
                  type="checkbox"
